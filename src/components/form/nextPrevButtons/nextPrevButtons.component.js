...
'use strict';
  ...
  module.exports = {
    ...
    controller: nextPrevButtonsController
  };

  nextPrevButtonsController.$inject = ['$state', 'EditReviewService', 'ImmunizationRecordService'];
  function nextPrevButtonsController ($state, EditReviewService, ImmunizationRecordService) {
