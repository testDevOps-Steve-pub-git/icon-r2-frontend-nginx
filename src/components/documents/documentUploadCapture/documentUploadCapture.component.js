...
'use strict';
  ...
  documentUploadCaptureController.$inject = ['$translate', 'Notify', 'ICON_NOTIFICATION', 'FileUploadHandler', 'ICON_FILE_UPLOAD'];
  function documentUploadCaptureController ($translate, Notify, ICON_NOTIFICATION, FileUploadHandler, ICON_FILE_UPLOAD) {
