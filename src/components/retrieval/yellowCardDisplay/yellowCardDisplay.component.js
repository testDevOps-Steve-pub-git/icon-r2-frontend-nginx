/* @ngInject */
function yellowCardDisplay$ctrl ($q, $translate, Endpoint, DISEASE_YC_ORDER, By, GroupsOf, ImmunizationRecordService) {
  this.$onInit = () => {
...
export default {
  name: 'yellowCardDisplay',
  component: {
    controller: yellowCardDisplay$ctrl,
