...
const DHIR_ERROR = {
  RETRIEVAL: {
    ...
    FAILED_AUTHENTICATION:      ResponseProfile(401,   `throttled`,  ICON_NOTIFICATION.WARN_RETRIEVAL_SECURITY_LOCK_OUT),
    BAD_PIN:                    ResponseProfile(401,   `security`,   ICON_NOTIFICATION.WARN_RETRIEVAL_BAD_PIN),
